    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('project.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-12">
                            ...
                            <select class="select2-single form-control select2-hidden-accessible" name="project_status" id="project_status" data-select2-id="3" tabindex="-3" aria-hidden="true">
                                ...
                                @foreach($project_statuses as $project_status)
                                    <option @if(old('project_status') == $project_status->id) selected @endif value="{{ $project_status->id }}">{{ $project_status->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id="project_id" name="project_id" placeholder="Project id" value="{{ old('project_id') }}">
                            @error('project_id')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="summernote-description" id="agreement" name="agreement">{!! old('agreement') !!}</textarea>
                            @error('agreement')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
