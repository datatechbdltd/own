    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('account.asset.update', $asset) }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group col-12">
                            ...
                            <select class="select2-single form-control select2-hidden-accessible" name="asset_category" id="asset_category" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                ...
                                @foreach($asset_categories as $asset_category)
                                    <option @if($asset->category_id == $asset_category->id) selected @endif value="{{ $asset_category->id }}">{{ $asset_category->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id="price" name="price" placeholder="Price" value="{{ $asset->price }}">
                            @error('price')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id="quantity" name="quantity" placeholder="Quantity" value="{{ $asset->quantity }}">
                            @error('quantity')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="summernote-description" id="description" name="description">{!! $asset->description !!}</textarea>
                            @error('description')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
