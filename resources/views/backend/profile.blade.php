                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link mb-2 active" id="v-pills-dashboard-tab" data-toggle="pill" href="{{ route('dashboard') }}" role="tab" aria-controls="v-pills-dashboard" aria-selected="true"><i class="feather icon-grid mr-2"></i>Dashboard</a>
                            ...
                            <div class="card-body">
                                <div class="profilebox py-4 text-center">
                                    ...
                                    <div class="profilename">
                                        <h5>Shourya Kumar</h5>
                                        <p class="text-muted"><a href="{{url('/template/panel-vertical/my-account')}}"><i class="feather icon-edit-2 mr-2"></i>Edit Profile</a></p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-sm-6 col-md-6 col-lg-4">
                                        <img src="assets/panel/vertical/images/ecommerce/wallet.svg" class="img-fluid" alt="wallet">
                                    </div>
                                </div>
