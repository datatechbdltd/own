            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:0"> Expense list</a></li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ route('account.expense.create') }}" class="btn btn-primary">{{ __('Create') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('account.expense.index') !!}',
                columns: [
