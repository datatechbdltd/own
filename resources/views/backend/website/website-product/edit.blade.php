                ...
                <div class="card-body">
                    <form action="{{ route('website.websiteProduct.update', $websiteProduct) }}" method="post" class="row" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="summernote-description" name="long_description">{!! $websiteProduct->long_description !!}</textarea>
                        </div>
                        <div class="form-group col-12">
                            <label>Agreement</label>
                            <textarea class="summernote-description" name="agreement">{!! $websiteProduct->agreement !!}</textarea>
                        </div>
                        <div class="form-group col-12">
