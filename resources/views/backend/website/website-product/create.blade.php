    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('website.websiteProduct.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input  value="{{ old('price') }}" type="number" name="price" required class="form-control" id="price" >
                            @error('price')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input  value="{{ old('offer_in_percent') }}" type="number" name="offer_in_percent" required class="form-control" id="offer_in_percent" >
