    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('website.websiteClient.update' ,$websiteClient) }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group col-md-6 col-xl-6">
                            <label for="name">Name <span class="text-danger">*</span></label>
                            <input value="{{ $websiteClient->name }}" type="text" name="name" required class="form-control" id="name" >
                            @error('name')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ $websiteClient->designation }}"  type="text" name="designation" required class="form-control" id="designation" >
                            @error('designation')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ $websiteClient->title }}"  type="text" name="title" required class="form-control" id="title" >
                            @error('title')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <textarea type="text" class="form-control" id="description" name="description" placeholder="{{ __('Enter description') }}" required> {{ $websiteClient->description }} </textarea>
                            @error('description')
                        ...
                        <div class="form-group  col-md-6 col-xl-6">
                            ...
                            <select id="Status" class="select2-single form-control select2-hidden-accessible" name="status" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                <option @if($websiteClient->is_active == true) selected @endif value="1">Active</option>
                                <option @if($websiteClient->is_active == false) selected @endif value="0">Inactive</option>
                            </select>
                            @error('status')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input  value="{{ $websiteClient->company_url }}"  type="text" name="company_url" required class="form-control" id="company_url" >
                            @error('company_url')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input  value="{{ $websiteClient->serial }}"  type="number" name="serial" required class="form-control" id="serial" >
                            @error('serial')
                            <small id="serial" class="form-text text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-xl-6">
                            <img height="80px;" width="80px;" class="rounded-circle" src="{{ asset($websiteClient->image ?? get_static_option('no_image')) }}">
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            <img height="80px;" width="80px;" class="rounded-circle" src="{{ asset($websiteClient->company_logo ?? get_static_option('no_image')) }}">
