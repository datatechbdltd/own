    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('website.websiteTeam.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ old('facebook_link') }}" type="text" name="facebook_link"  class="form-control" id="facebook_link" >
                            @error('facebook_link')
                            <small id="url" class="form-text text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ old('twitter_link') }}" type="text" name="twitter_link"  class="form-control" id="twitter_link" >
                            @error('twitter_link')
                            <small id="url" class="form-text text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ old('github_link') }}" type="text" name="github_link"  class="form-control" id="github_link" >
                            @error('github_link')
                        ...
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ old('linkedin_link') }}" type="text" name="linkedin_link"  class="form-control" id="linkedin_link" >
                            @error('linkedin_link')
                            <small id="url" class="form-text text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-xl-6">
                            ...
                            <input value="{{ old('serial') }}" type="number" name="serial"  class="form-control" id="serial" >
                            @error('serial')
                            <small id="serial" class="form-text text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-xl-6">
                            <img width="70px;" height="70px;" class="rounded-circle" src="{{ asset('assets/frontend/images/resource/team-4.png' ?? get_static_option('no_image')) }}" alt="">
