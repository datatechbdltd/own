    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">{{ __('Banner create') }}</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">{{ config('app.name') }}</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Website banner create') }}</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">{{ __('Create website banner') }}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('website.websiteBanner.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                          <div class="row">
                              <div class="form-group col-md-6 col-xl-4">
                                  <label for="title">{{ __('Title')  }}</label>
                                  <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}"  placeholder="{{ __('Enter title') }}">
                                  @error('title')
                              ...
                              <div class="form-group col-md-6 col-xl-4">
                                  ...
                                  <input type="text" class="form-control" id="highlight" name="highlight" value="{{ old('highlight') }}"  placeholder="{{ __('Enter highlight text') }}" required>
                                  @error('highlight')
                              ...
                              <div class="form-group col-md-6 col-xl-4">
                                  ...
                                  <input type="text" class="form-control" id="btn_url" name="btn_url" value="{{ old('btn_url') }}"  placeholder="{{ __('Enter button url') }}">
                                  @error('btn_url')
                              ...
                              <div class="form-group col-md-6 col-xl-4">
                                  ...
                                  <input type="text" class="form-control" id="video_url" name="video_url" value="{{ old('video_url') }}"  placeholder="{{ __('Video button url') }}">
                                  @error('video_url')
                              ...
                              <div class="form-group col-md-6 col-xl-4">
                                  ...
                                  <div id="initial-rgb-color" class="input-group" title="Using input value">
                                      <input type="text" class="form-control input-lg" id="color" name="color" value="{{ old('color') ?? "#944dff" }}"/>
                              ...
                              <div class="form-group col-md-6 col-xl-4">
                                  ...
                                  <input type="number" class="form-control" id="serial" name="serial" value="{{ old('serial') }}"  placeholder="{{ __('Enter serial') }}" required>
                                  @error('serial')
