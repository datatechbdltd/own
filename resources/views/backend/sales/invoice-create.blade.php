    ...
    <div class="contentbar">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ route('sales.invoice.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" class="form-control" id="vat" name="vat" placeholder="Vat" value="{{ old('vat') }}">
                            @error('vat')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" class="form-control" id="product_vat" name="product_vat" placeholder="Product vat" value="{{ old('product_vat') }}">
                            @error('product_vat')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" class="form-control" id="product_price" name="product_price" placeholder="Product price" value="{{ old('product_price') }}">
                            @error('product_price')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="summernote-description" id="product_note" name="product_note">{!! old('product_note') !!}</textarea>
                            @error('product_note')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" class="form-control" id="service_vat" name="service_vat" placeholder="Service vat" value="{{ old('service_vat') }}">
                            @error('service_vat')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" class="form-control" id="price" name="service_price" placeholder="Service price" value="{{ old('service_price') }}">
                            @error('service_price')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
