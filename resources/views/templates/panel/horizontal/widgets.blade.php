...
@section('script')
<!-- To Do List js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-to-do-list.js') }}"></script>
<!-- Dropzone JS -->
...
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-widgets.js') }}"></script>
@endsection
