                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="auth-box-icon">
                                        <img src="assets/panel/horizontal/images/authentication/auth-box-icon-forgot.svg" class="img-fluid" alt="auth-box-icon">
                                    </div>
                        ...
                        <div class="auth-box-right">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 mt-3">Remember Password? <a href="{{url('/template/panel-horizontal/user-login')}}">Log in</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Auth Box -->
