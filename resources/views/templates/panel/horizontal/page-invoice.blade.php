                            ...
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    <div class="invoice-logo">
                                        <img src="assets/panel/horizontal/images/logo.svg" class="img-fluid" alt="invoice-logo">
                                    </div>
                                    ...
                                    <div class="order-total table-responsive ">
                                        <table class="table table-borderless text-right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-white f-w-7 font-18">Amount Payable :</td>
                                                    <td class="text-white f-w-7 font-18">$1180.00</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="invoice-meta-box text-right">
                                        ...
                                        <img src="assets/panel/horizontal/images/general/signature.svg" class="img-fluid my-3" alt="signature">
