                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <div class="profilebox py-4 text-center">
                                <img src="assets/panel/horizontal/images/users/profile.svg" class="img-fluid" alt="profile">
                                <div class="profilename">
                                    <h5>Shourya Kumar</h5>
                                    <p class="text-muted"><a href="{{url('/template/panel-horizontal/my-account')}}"><i class="feather icon-edit-2 mr-2"></i>Edit Profile</a></p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-sm-6 col-md-6 col-lg-4">
                                    <img src="assets/panel/horizontal/images/ecommerce/wallet.svg" class="img-fluid" alt="wallet">
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-xl-4">
                                    <div class="logout-content text-center my-5">
                                        <img src="assets/panel/horizontal/images/ecommerce/logout.svg" class="img-fluid mb-5" alt="logout">
...
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-ecommerce-myaccount.js') }}"></script>
@endsection
