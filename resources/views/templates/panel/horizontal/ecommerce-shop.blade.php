...
@section('style')
<!-- Range Slider css -->
<link href="{{ asset('assets/panel/horizontal/plugins/ion-rangeSlider/ion.rangeSlider.css') }}" rel="stylesheet" type="text/css">
@endsection
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="badge-list">
                        <a href="#" class="badge badge-light-inverse">New</a>
                        <a href="#" class="badge badge-light-inverse">Latest</a>
                        <a href="#" class="badge badge-light-inverse">Featured</a>
                        <a href="#" class="badge badge-light-inverse">Popular</a>
                        <a href="#" class="badge badge-light-inverse">Trending</a>
                        <a href="#" class="badge badge-light-inverse">Sale</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="product"></a>
...
@section('script')
<!-- Range Slider js -->
<script src="{{ asset('assets/panel/horizontal/plugins/ion-rangeSlider/ion.rangeSlider.min.js') }}"></script>
<!-- eCommerce Shop Page js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-ecommerce-shop-page.js') }}"></script>
@endsection
