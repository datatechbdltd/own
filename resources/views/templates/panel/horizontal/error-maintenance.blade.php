                 ...
                 <div class="row no-gutters align-items-center justify-content-center">
                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="text-center">
                            ...
                            <img src="assets/panel/horizontal/images/error/maintenance.svg" class="img-fluid error-image" alt="maintenance">
                            ...
                            <a href="{{url('/template/panel-horizontal//')}}" class="btn btn-primary font-16"><i class="feather icon-home mr-2"></i> Go back to Dashboard</a>
                        </div>
                    </div>
                    <!-- End col -->
                </div>
