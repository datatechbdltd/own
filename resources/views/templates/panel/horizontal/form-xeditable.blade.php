...
@section('style')
<!-- X-editable css -->
<link href="{{ asset('assets/panel/horizontal/plugins/bootstrap-xeditable/css/bootstrap-editable.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- X-editable js -->
<script src="{{ asset('assets/panel/horizontal/plugins/bootstrap-xeditable/js/bootstrap-editable.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/moment/moment.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-xeditable.js') }}"></script>
@endsection
