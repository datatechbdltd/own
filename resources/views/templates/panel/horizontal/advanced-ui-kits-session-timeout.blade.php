...
@section('script')
<!-- Session Timeout js -->
<script src="{{ asset('assets/panel/horizontal/plugins/bootstrap-session-timeout/js/bootstrap-session-timeout.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-session-timeout.js') }}"></script>
@endsection
