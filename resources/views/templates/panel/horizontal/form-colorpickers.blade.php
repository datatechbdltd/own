...
@section('style')
<!-- Color Picker css -->
<link href="{{ asset('assets/panel/horizontal/plugins/colorpicker/bootstrap-colorpicker.css') }}" rel="stylesheet" type="text/css">
@endsection
...
@section('script')
<!-- Color Picker js -->
<script src="{{ asset('assets/panel/horizontal/plugins/colorpicker/bootstrap-colorpicker.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-colorpicker.js') }}"></script>
@endsection
