...
@section('style')
<!-- Cropper css -->
<link href="{{ asset('assets/panel/horizontal/plugins/cropperjs/cropper.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('assets/panel/horizontal/plugins/cropperjs/main.css') }}" rel="stylesheet" type="text/css" />
@endsection
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="img-container">
                      <img src="assets/panel/horizontal/images/general/image-crop.jpg" id="image" class="cropper-hidden" alt="Picture">
                    </div>
                </div>
            </div>
            <div class="card m-b-30">
...
@section('script')
<!-- Cropper js -->
<script src="{{ asset('assets/panel/horizontal/plugins/cropperjs/cropper.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/cropperjs/main.js') }}"></script>
@endsection
