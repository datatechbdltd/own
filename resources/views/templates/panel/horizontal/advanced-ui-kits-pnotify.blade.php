...
@section('style')
<!-- Pnotify css -->
<link href="{{ asset('assets/panel/horizontal/plugins/pnotify/css/pnotify.custom.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Pnotify js -->
<script src="{{ asset('assets/panel/horizontal/plugins/pnotify/js/pnotify.custom.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-pnotify.js') }}"></script>
@endsection
