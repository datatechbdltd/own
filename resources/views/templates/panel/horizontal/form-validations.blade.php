...
@section('script')
<!-- Parsley js -->
<script src="{{ asset('assets/panel/horizontal/plugins/validatejs/validate.min.js') }}"></script>
<!-- Validate js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-validate.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-validation.js') }}"></script>
@endsection
