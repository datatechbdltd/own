...
@section('style')
<!-- RWD Table css -->
<link href="{{ asset('assets/panel/horizontal/plugins/rwd-table-patterns/rwd-table.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- RWD Table js -->
<script src="{{ asset('assets/panel/horizontal/plugins/rwd-table-patterns/rwd-table.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-table-rwd.js') }}"></script>
@endsection
