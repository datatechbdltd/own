...
@section('script')
<!-- Form Step js -->
<script src="{{ asset('assets/panel/horizontal/plugins/jquery-step/jquery.steps.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-wizard.js') }}"></script>
<!-- Card js -->
<script src="{{ asset('assets/panel/horizontal/plugins/creditcard/card.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-creditcard.js') }}"></script>
@endsection
