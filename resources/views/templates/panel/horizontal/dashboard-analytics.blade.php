...
@section('style')
<!-- Morris Chart css -->
<link href="{{ asset('assets/panel/horizontal/plugins/morris/morris.css') }}" rel="stylesheet" type="text/css" />
<!-- Datepicker css -->
...
@section('script')
<!-- Morris Chart js -->
<script src="{{ asset('assets/panel/horizontal/plugins/morris/morris.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/raphael/raphael-min.js') }}"></script>
<!-- Piety Chart js -->
<script src="{{ asset('assets/panel/horizontal/plugins/peity/jquery.peity.min.js') }}"></script>
<!-- Dashboard js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-dashboard-analytics.js') }}"></script>
@endsection
