...
@section('script')
<!-- MaxLength js -->
<script src="{{ asset('assets/panel/horizontal/plugins/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-maxlength.js') }}"></script>
@endsection
