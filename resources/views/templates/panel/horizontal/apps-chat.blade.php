            ...
            <div class="chat-list">
                ...
                <div class="chat-user-list">
                    <ul class="list-unstyled mb-0">
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/panel/horizontal/images/users/girl.svg" alt="Generic placeholder image">
                        ...
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/panel/horizontal/images/users/boy.svg" alt="Generic placeholder image">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/panel/horizontal/images/users/men.svg" alt="Generic placeholder image">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="align-self-center rounded-circle" src="assets/panel/horizontal/images/users/women.svg" alt="Generic placeholder image">
                            <div class="media-body">
        ...
        <div class="col-lg-7 col-xl-8">
            <div class="chat-detail">
                <div class="chat-head">
                    <ul class="list-unstyled mb-0">
                        <li class="media">
                            <img class="align-self-center mr-3 rounded-circle" src="assets/panel/horizontal/images/users/girl.svg" alt="Generic placeholder image">
                            <div class="media-body">
...
@section('script')
<!-- Chat js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-chat.js') }}"></script>
@endsection
