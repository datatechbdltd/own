    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-1.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card m-b-30">
                ...
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-2.jpg" alt="Card image cap">
            </div>
        </div>
        <!-- End col -->
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-3.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-4.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title font-18">Card title</h5>
        ...
        <div class="col-md-12 col-lg-12 col-xl-8">
            <div class="card m-b-30">
              <div class="row no-gutters">
                <div class="col-md-6">
                  <img src="assets/panel/horizontal/images/ui-cards/ui-cards-5.jpg" class="card-img h-100" alt="Card image">
                </div>
                <div class="col-md-6">
                  <div class="card-body">
                    <h5 class="card-title font-18">Card title</h5>
        ...
        <div class="col-md-12 col-lg-12 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-6.jpg" alt="Card image">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-group m-b-30">
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-7.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-8.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-9.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
        ...
        <div class="col-lg-12">
            <div class="card-group m-b-30">
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-10.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                    </div>
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-11.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                        <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                    </div>
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-12.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card-deck m-b-30">
              <div class="card">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-13.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title font-18">Card title</h5>
              ...
              <div class="card">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-14.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title font-18">Card title</h5>
                    <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              ...
              <div class="card">
                <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-15.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title font-18">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="col-lg-12">
            <div class="card-columns m-b-30">
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-16.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-17.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title font-18">Card title</h5>
                        <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                ...
                <div class="card">
                    <img class="card-img-top" src="assets/panel/horizontal/images/ui-cards/ui-cards-18.jpg" alt="Card image cap">
                </div>
