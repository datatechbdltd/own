...
@section('script')
<!-- Sparkline Chart JS -->
<script src="{{ asset('assets/panel/horizontal/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-chart-sparkline.js') }}"></script>
@endsection
