...
@section('style')
<!-- Footabel css -->
<link href="{{ asset('assets/panel/horizontal/plugins/footable/css/footable.bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
<script src="{{ asset('assets/panel/horizontal/plugins/footable/js/footable.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-table-footable.js') }}"></script>
@endsection
