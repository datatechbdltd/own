...
@section('script')
<!-- Datepicker JS -->
<script src="{{ asset('assets/panel/horizontal/plugins/datepicker/datepicker.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datepicker/i18n/datepicker.en.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-datepicker.js') }}"></script>
@endsection
