...
@section('style')
<!-- Slick css -->
<link href="{{ asset('assets/panel/horizontal/plugins/slick/slick.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('assets/panel/horizontal/plugins/slick/slick-theme.css') }}" rel="stylesheet" type="text/css">
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-xl-5">
                            <div class="product-slider-box product-box-for">
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="Product">
                                    <p><span class="badge badge-success font-14">25% off</span></p>
                                </div>
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_02.jpg" class="img-fluid" alt="Product">
                                    <p><span class="badge badge-primary font-14">New</span></p>
                                </div>
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_03.jpg" class="img-fluid" alt="Product">
                                    <p><span class="badge badge-danger font-14">Price Drop</span></p>
                                </div>
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_04.jpg" class="img-fluid" alt="Product">
                                    <p><span class="badge badge-success font-14">Sale</span></p>
                                </div>
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_05.jpg" class="img-fluid" alt="Product">
                                    <p><span class="badge badge-warning font-14">Trending</span></p>
                                </div>
                                <div class="product-preview">
                                    <img src="assets/panel/horizontal/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="Product">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            <p><span class="badge badge-light-inverse font-16">Pupular</span></p>
                    ...
                    <div class="tab-content" id="defaultTabContentLine">
                        ...
                        <div class="tab-pane fade" id="review-line" role="tabpanel" aria-labelledby="review-tab-line">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="assets/panel/horizontal/images/users/men.svg" class="img-fluid mr-3" alt="user">
                                ...
                                <li class="media my-4">
                                    <img src="assets/panel/horizontal/images/users/boy.svg" class="img-fluid mr-3" alt="user">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="assets/panel/horizontal/images/users/girl.svg" class="img-fluid mr-3" alt="user">
                                    <div class="media-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_02.jpg" class="img-fluid" alt="product"></a>
                                    <p><span class="badge badge-primary font-14">New</span></p>
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_03.jpg" class="img-fluid" alt="product"></a>
                                    <p><span class="badge badge-danger font-14">Price Drop</span></p>
                                </div>
                                <div class="product-body py-3">
                                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_04.jpg" class="img-fluid" alt="product"></a>
                                    <p><span class="badge badge-success font-14">Sale</span></p>
                                </div>
                                <div class="product-body py-3">
                                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-horizontal/ecommerce-single-product')}}"><img src="assets/panel/horizontal/images/ecommerce/product_img_05.jpg" class="img-fluid" alt="product"></a>
                                    <p><span class="badge badge-warning font-14">Trending</span></p>
                                </div>
                                <div class="product-body py-3">
                                    <div class="row align-items-center">
...
@section('script')
<!-- Slick js -->
<script src="{{ asset('assets/panel/horizontal/plugins/slick/slick.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-ecommerce-single-product.js') }}"></script>
@endsection
