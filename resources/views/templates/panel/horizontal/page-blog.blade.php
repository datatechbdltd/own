    ...
    <div class="row">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-1.jpg" alt="blog">
                <div class="card-body">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-2.jpg" alt="blog">
                <div class="card-body">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-3.jpg" alt="blog">
                <div class="card-body">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-4.jpg" alt="blog">
                <div class="card-body">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-5.jpg" alt="blog">
                <div class="card-body">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30">
                <img class="card-img-top" src="assets/panel/horizontal/images/blog/blog-6.jpg" alt="blog">
                <div class="card-body">
