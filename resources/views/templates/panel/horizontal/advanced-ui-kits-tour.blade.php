...
@section('style')
<!-- Product Tour css -->
<link href="{{ asset('assets/panel/horizontal/plugins/product-tour/product-tour.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
            ...
            <div class="card m-b-30" id="tour-upload">
                ...
                <div class="card-body">
                    <div class="ecommerce-upload">
                        ...
                        <img src="assets/panel/horizontal/images/dashboard/cloud.svg" class="img-fluid" alt="colud">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Product Tour js -->
<script src="{{ asset('assets/panel/horizontal/plugins/product-tour/product-tour.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-tour.js') }}"></script>
@endsection
