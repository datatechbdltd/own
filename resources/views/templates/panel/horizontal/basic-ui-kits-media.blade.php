        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <img class="mr-3 rounded-circle" src="assets/panel/horizontal/images/users/boy.svg" alt="Generic placeholder image">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        ...
                        <img class="ml-3 rounded-circle" src="assets/panel/horizontal/images/users/girl.svg" alt="Generic placeholder image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="media m-b-30">
                        <img class="align-self-start mr-3 rounded-circle" src="assets/panel/horizontal/images/users/men.svg" alt="Generic placeholder image">
                        <div class="media-body">
                    ...
                    <div class="media m-b-30">
                        <img class="align-self-center mr-3 rounded-circle" src="assets/panel/horizontal/images/users/women.svg" alt="Generic placeholder image">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="align-self-end mr-3 rounded-circle" src="assets/panel/horizontal/images/users/boy.svg" alt="Generic placeholder image">
                        <div class="media-body">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li class="media">
                            <img class="mr-3 rounded-circle" src="assets/panel/horizontal/images/users/girl.svg" alt="Generic placeholder image">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" src="assets/panel/horizontal/images/users/women.svg" alt="Generic placeholder image">
                            <div class="media-body">
                            <h5 class="mt-0 mb-1 font-16">List-based media object</h5>
                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                            </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <a class="pr-3" href="#">
                                    <img class="rounded-circle" src="assets/panel/horizontal/images/users/men.svg" alt="Generic placeholder image">
                                </a>
                                <div class="media-body">
                                <h5 class="mt-0 font-16">Media heading</h5>
                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
