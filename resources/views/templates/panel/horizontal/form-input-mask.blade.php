...
@section('script')
<!-- Input Mask js -->
<script src="{{ asset('assets/panel/horizontal/plugins/bootstrap-inputmask/jquery.inputmask.bundle.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-inputmask.js') }}"></script>
@endsection
