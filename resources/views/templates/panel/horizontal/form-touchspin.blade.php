...
@section('style')
<!-- Touchspin css -->
<link href="{{ asset('assets/panel/horizontal/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Touchspin js -->
<script src="{{ asset('assets/panel/horizontal/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-form-touchspin.js') }}"></script>
@endsection
