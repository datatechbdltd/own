...
<script src="{{ asset('assets/panel/horizontal/plugins/jquery-bar-rating/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-barrating.js') }}"></script>
@endsection
