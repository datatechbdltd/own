...
@section('style')
<!-- Dragula css -->
<link href="{{ asset('assets/panel/horizontal/plugins/dragula/dragula.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
                                            ...
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/horizontal/images/users/men.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/horizontal/images/users/women.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/horizontal/images/users/boy.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
...
@section('script')
<!-- Dragula js -->
<script src="{{ asset('assets/panel/horizontal/plugins/dragula/dragula.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-kanban.js') }}"></script>
@endsection
