...
@section('script')
<!-- Tabledit js -->
<script src="{{ asset('assets/panel/horizontal/plugins/tabledit/jquery.tabledit.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-table-editable.js') }}"></script>
@endsection
