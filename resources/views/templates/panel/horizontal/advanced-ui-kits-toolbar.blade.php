...
@section('style')
 <!-- Toolbar css -->
<link href="{{ asset('assets/panel/horizontal/plugins/toolbar/jquery.toolbar.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Toolbar js -->
<script src="{{ asset('assets/panel/horizontal/plugins/toolbar/jquery.toolbar.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-toolbar.js') }}"></script>
@endsection
