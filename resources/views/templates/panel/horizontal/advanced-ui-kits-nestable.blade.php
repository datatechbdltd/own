...
@section('style')
<!-- Nestable css -->
<link href="{{ asset('assets/panel/horizontal/plugins/nestable/jquery.nestable.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Nestable js -->
<script src="{{ asset('assets/panel/horizontal/plugins/nestable/jquery.nestable.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-nestable.js') }}"></script>
@endsection
