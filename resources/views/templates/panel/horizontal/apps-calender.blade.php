...
@section('style')
<!-- Calendar css -->
<link href="{{ asset('assets/panel/horizontal/plugins/fullcalendar/css/fullcalendar.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- jQuery UI -->
<script src="{{ asset('assets/panel/horizontal/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/moment/moment.js') }}"></script>
<!-- Events js -->
<script src="{{ asset('assets/panel/horizontal/plugins/fullcalendar/js/fullcalendar.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-calender.js') }}"></script>
@endsection
