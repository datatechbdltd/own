                        ...
                        <div class="col-lg-10 col-xl-8">
                            <div class="cart-container">
                                            ...
                                            <div class="order-total table-responsive ">
                                                <table class="table table-borderless text-right">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-white f-w-7 font-18">Amount :</td>
                                ...
                                <div class="cart-footer text-right">
                                    ...
                                    <a href="{{url('/template/panel-horizontal/page-checkout')}}" class="btn btn-success-rgba my-1">Proceed to Checkout<i class="feather icon-arrow-right ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
