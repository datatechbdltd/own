...
@section('style')
<!-- Animate css -->
<link href="{{ asset('assets/panel/horizontal/plugins/animate/animate.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Model js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-model.js') }}"></script>
@endsection
