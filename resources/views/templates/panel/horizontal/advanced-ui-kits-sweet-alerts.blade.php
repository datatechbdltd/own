...
@section('style')
<!-- Sweet Alert css -->
<link href="{{ asset('assets/panel/horizontal/plugins/sweet-alert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Sweet-Alert js -->
<script src="{{ asset('assets/panel/horizontal/plugins/sweet-alert2/sweetalert2.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-sweet-alert.js') }}"></script>
@endsection
