...
@section('style')
<!-- DataTables css -->
<link href="{{ asset('assets/panel/horizontal/plugins/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('assets/panel/horizontal/plugins/datatables/buttons.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
<!-- Dropzone css -->
<link href="{{ asset('assets/panel/horizontal/plugins/dropzone/dist/dropzone.css') }}" rel="stylesheet" type="text/css" />
<!-- C3 Charts css -->
<link href="{{ asset('assets/panel/horizontal/plugins/c3/c3.min.css') }}" rel="stylesheet" type="text/css" />
<!-- Datepicker css -->
<link href="{{ asset('assets/panel/horizontal/plugins/datepicker/datepicker.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body pb-1">
                    <div class="ecommerce-upload">
                        ...
                        <img src="assets/panel/horizontal/images/dashboard/cloud.svg" class="img-fluid" alt="cloud">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">#1</th>
                                    <td><img src="assets/panel/horizontal/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#2</th>
                                    <td><img src="assets/panel/horizontal/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#3</th>
                                    <td><img src="assets/panel/horizontal/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#4</th>
                                    <td><img src="assets/panel/horizontal/images/users/girl.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#7</th>
                                    <td><img src="assets/panel/horizontal/images/users/boy.svg" class="img-fluid" width="35" alt="men"></td>
                                    <td>John Terry</td>
                                    <td>29-12-2018</td>
                                    <td>$3,695</td>
                                </tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">#1</th>
                                    <td><img src="assets/panel/horizontal/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Apple MacBook Pro</td>
                                    <td>10,598</td>
                                </tr>
                                <tr>
                                    <th scope="row">#2</th>
                                    <td><img src="assets/panel/horizontal/images/ecommerce/product_02.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Dell Alienware</td>
                                    <td>8,986</td>
                                </tr>
                                <tr>
                                    <th scope="row">#3</th>
                                    <td><img src="assets/panel/horizontal/images/ecommerce/product_03.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Acer Predator Helios</td>
                                    <td>5,987</td>
                                </tr>
                                <tr>
                                    <th scope="row">#4</th>
                                    <td><img src="assets/panel/horizontal/images/ecommerce/product_04.svg" class="img-fluid" width="35" alt="product"></td>
...
@section('script')
<!-- Chartjs js -->
<script src="{{ asset('assets/panel/horizontal/plugins/chart.js/chart.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/chart.js/chart-bundle.min.js') }}"></script>
<!-- Piety Chart js -->
<script src="{{ asset('assets/panel/horizontal/plugins/peity/jquery.peity.min.js') }}"></script>
<!-- Dropzone JS -->
<script src="{{ asset('assets/panel/horizontal/plugins/dropzone/dist/dropzone.js') }}"></script>
<!-- Required Datatable js -->
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/dataTables.bootstrap4.min.js') }}"></script>
<!-- Datatable js -->
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/buttons.bootstrap4.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/jszip.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/pdfmake.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/vfs_fonts.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/buttons.html5.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/buttons.print.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/buttons.colVis.min.js') }}"></script>
<!-- Responsive Examples -->
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/datatables/responsive.bootstrap4.min.js') }}"></script>
<!-- C3 Chart js -->
<script src="{{ asset('assets/panel/horizontal/plugins/d3/d3.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/plugins/c3/c3.min.js') }}"></script>
<!-- Dashboard js -->
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-dashboard-ecommerce.js') }}"></script>
@endsection
