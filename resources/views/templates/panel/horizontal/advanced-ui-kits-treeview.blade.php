...
@section('style')
<!-- JS Tree css -->
<link href="{{ asset('assets/panel/horizontal/plugins/jstree/jstree.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- JS Tree js -->
<script src="{{ asset('assets/panel/horizontal/plugins/jstree/jstree.min.js') }}"></script>
<script src="{{ asset('assets/panel/horizontal/js/custom/custom-jstree.js') }}"></script>
@endsection
