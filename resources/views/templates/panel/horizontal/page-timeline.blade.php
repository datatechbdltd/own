...
<link href="{{ asset('assets/panel/horizontal/plugins/vertical-timeline/vertical-timeline.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Timeline js -->
<script src="{{ asset('assets/panel/horizontal/plugins/vertical-timeline/vertical-timeline.js') }}"></script>
@endsection
