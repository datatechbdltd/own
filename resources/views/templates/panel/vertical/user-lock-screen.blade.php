                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="auth-box-icon">
                                        <img src="assets/panel/vertical/images/authentication/auth-box-icon-lock.svg" class="img-fluid" alt="auth-box-icon">
                                    </div>
                                ...
                                <div class="card-body">
                                    <form action="#">
                                        ...
                                        <div class="user-logo mb-4">
                                            <img src="assets/panel/vertical/images/users/boy.svg" class="rounded-circle img-fluid" alt="user-img">
                                        </div>
                                    ...
                                    <p class="mb-0 mt-3">Not You? Go to <a href="{{url('/template/panel-vertical/user-login')}}">Log in</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Auth Box -->
