...
@section('script')
<!-- MaxLength js -->
<script src="{{ asset('assets/panel/vertical/plugins/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-form-maxlength.js') }}"></script>
@endsection
