                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="{{url('/template/panel-vertical/page-order-detail')}}" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="{{url('/template/panel-vertical/page-order-detail')}}" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
                                            <a href="{{url('/template/panel-vertical/page-order-detail')}}" class="btn btn-danger-rgba"><i class="feather icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
