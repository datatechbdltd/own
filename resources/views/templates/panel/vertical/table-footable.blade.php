...
@section('style')
<!-- Footabel css -->
<link href="{{ asset('assets/panel/vertical/plugins/footable/css/footable.bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
<script src="{{ asset('assets/panel/vertical/plugins/footable/js/footable.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-table-footable.js') }}"></script>
@endsection
