...
@section('style')
<!-- Calendar css -->
<link href="{{ asset('assets/panel/vertical/plugins/fullcalendar/css/fullcalendar.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- jQuery UI -->
<script src="{{ asset('assets/panel/vertical/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/moment/moment.js') }}"></script>
<!-- Events js -->
<script src="{{ asset('assets/panel/vertical/plugins/fullcalendar/js/fullcalendar.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-calender.js') }}"></script>
@endsection
