...
@section('script')
<!-- Datepicker JS -->
<script src="{{ asset('assets/panel/vertical/plugins/datepicker/datepicker.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/datepicker/i18n/datepicker.en.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-form-datepicker.js') }}"></script>
@endsection
