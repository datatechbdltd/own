...
<script src="{{ asset('assets/panel/vertical/plugins/jquery-bar-rating/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-barrating.js') }}"></script>
@endsection
