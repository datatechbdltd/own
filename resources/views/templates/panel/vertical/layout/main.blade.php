    ...
    <body class="vertical-layout">
        ...
        <div id="infobar-notifications-sidebar" class="infobar-notifications-sidebar">
            <div class="infobar-notifications-sidebar-head d-flex w-100 justify-content-between">
                <h4>Notifications</h4><a href="javascript:void(0)" id="infobar-notifications-close" class="infobar-notifications-close"><img src="assets/panel/vertical/images/svg-icon/close.svg" class="img-fluid menu-hamburger-close" alt="close"></a>
            </div>
                ...
                <div class="tab-content" id="infobar-pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-messages" role="tabpanel" aria-labelledby="pills-messages-tab">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img class="mr-3 align-self-center rounded-circle" src="assets/panel/vertical/images/users/girl.svg" alt="Generic placeholder image">
                            ...
                            <li class="media">
                                <img class="mr-3 align-self-center rounded-circle" src="assets/panel/vertical/images/users/boy.svg" alt="Generic placeholder image">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 align-self-center rounded-circle" src="assets/panel/vertical/images/users/men.svg" alt="Generic placeholder image">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 align-self-center rounded-circle" src="assets/panel/vertical/images/users/women.svg" alt="Generic placeholder image">
                                <div class="media-body">
        ...
        <div id="infobar-settings-sidebar" class="infobar-settings-sidebar">
            <div class="infobar-settings-sidebar-head d-flex w-100 justify-content-between">
                <h4>Settings</h4><a href="javascript:void(0)" id="infobar-settings-close" class="infobar-settings-close"><img src="assets/panel/vertical/images/svg-icon/close.svg" class="img-fluid menu-hamburger-close" alt="close"></a>
            </div>
                    ...
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-6">
                            <div class="account-box active">
                                <img src="assets/panel/vertical/images/users/boy.svg" class="img-fluid" alt="user">
                                <h5>Shourya</h5>
                                <p>CEO</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="account-box">
                                <img src="assets/panel/vertical/images/users/women.svg" class="img-fluid" alt="user">
                                <h5>Amy</h5>
                                <p>COO</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="account-box">
                                <img src="assets/panel/vertical/images/users/men.svg" class="img-fluid" alt="user">
                                <h5>John</h5>
                                <p>MD</p>
                            </div>
                        </div>
        ...
        <div id="containerbar">
            <!-- Start Leftbar -->
            @include('templates.panel.vertical.layout.leftbar')
            <!-- End Leftbar -->
            <!-- Start Rightbar -->
            @include('templates.panel.vertical.layout.rightbar')
            @yield('content')
            <!-- End Rightbar -->
        </div>
        <!-- End Containerbar -->
