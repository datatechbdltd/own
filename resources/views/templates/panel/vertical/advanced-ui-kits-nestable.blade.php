...
@section('style')
<!-- Nestable css -->
<link href="{{ asset('assets/panel/vertical/plugins/nestable/jquery.nestable.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Nestable js -->
<script src="{{ asset('assets/panel/vertical/plugins/nestable/jquery.nestable.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-nestable.js') }}"></script>
@endsection
