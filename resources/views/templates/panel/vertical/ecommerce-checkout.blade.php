...
@section('script')
<!-- Form Step js -->
<script src="{{ asset('assets/panel/vertical/plugins/jquery-step/jquery.steps.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-form-wizard.js') }}"></script>
<!-- Card js -->
<script src="{{ asset('assets/panel/vertical/plugins/creditcard/card.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-creditcard.js') }}"></script>
@endsection
