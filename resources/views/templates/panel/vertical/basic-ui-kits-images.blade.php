    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-thumbnail.jpg" alt="Thumbnail Image" class="img-thumbnail">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-rounded.jpg" alt="Rounded Image" class="rounded">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-circle.jpg" alt="Rounded Image" class="rounded-circle">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-left.jpg" alt="Rounded Image" class="rounded float-left">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-center.jpg" alt="Rounded Image" class="rounded mx-auto d-block">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Align images with the helper float classes. <code class="highlighter-rouge">.float-left or .float-right</code></h6>
                    <img src="assets/panel/vertical/images/ui-images/image-right.jpg" alt="Rounded Image" class="rounded float-right">
                </div>
            </div>
        </div>
        <!-- End col -->
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <img src="assets/panel/vertical/images/ui-images/image-responsive.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div>
        </div>
        <!-- End col -->
