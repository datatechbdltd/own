                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4">
                            <div class="onboard-content text-center my-5">
                                <img src="assets/panel/vertical/images/ui-onboard/unboard.svg" class="img-fluid mb-5" alt="onboard">
                        ...
                        <div class="modal-body border-0">
                            <div id="onboard-screen" class="onboard-screen">
                                <div class="onboard-screen-list">
                                    <img src="assets/panel/vertical/images/ui-onboard/responsive.svg" class="img-fluid" alt="onboard">
                                ...
                                <div class="onboard-screen-list">
                                    <img src="assets/panel/vertical/images/ui-onboard/customisable.svg" class="img-fluid" alt="onboard">
                                    <h5 class="card-title my-4">Customisable</h5>
                                    <p class="text-muted">Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
                                </div>
                                <div class="onboard-screen-list">
                                    <img src="assets/panel/vertical/images/ui-onboard/easily-editable-code.svg" class="img-fluid" alt="onboard">
                                    <h5 class="card-title my-4">Easily Editable Code</h5>
                                    <p class="text-muted">Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
                                </div>
                                <div class="onboard-screen-list">
                                    <img src="assets/panel/vertical/images/ui-onboard/unique-widgets.svg" class="img-fluid" alt="onboard">
...
<script src="{{ asset('assets/panel/vertical/js/custom/custom-onboarding-screens.js') }}"></script>
@endsection
