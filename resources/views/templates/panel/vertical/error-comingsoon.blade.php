...
<body class="vertical-layout">
                 ...
                 <div class="row no-gutters align-items-center justify-content-center">
                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="text-center">
                            <img src="assets/panel/vertical/images/color_logo.svg" class="img-fluid error-logo" alt="logo">
                            <img src="assets/panel/vertical/images/error/coming-soon.svg" class="img-fluid error-image" alt="coming soon">
    ...
    <!-- Countdown js -->
    <script src="{{ asset('assets/panel/vertical/plugins/jquery-countdown/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('assets/panel/vertical/js/custom/custom-comingsoon.js') }}"></script>
    <!-- End js -->
</body>
</html>
