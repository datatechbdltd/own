...
@section('style')
<!-- jvectormap css -->
<link href="{{ asset('assets/panel/vertical/plugins/jvectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" type="text/css" />
<!-- Datepicker css -->
                ...
                <div class="card-body">
                    <div class="table-responsive dash-flag-icon">
                        <table class="table table-borderless mb-2">
                            ...
                            <tbody>
                              <tr>
                                <th scope="row"><img src="assets/panel/vertical/images/browser/chrome.png" class="img-fluid" alt="chrome"></th>
                                <td>Google Chrome</td>
                                <td>35%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/panel/vertical/images/browser/safari.png" class="img-fluid" alt="safari"></th>
                                <td>Safari</td>
                                <td>30%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/panel/vertical/images/browser/windows.png" class="img-fluid" alt="windows"></th>
                                <td>Microsoft Edge</td>
                                <td>20%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/panel/vertical/images/browser/mozilla.png" class="img-fluid" alt="mozilla"></th>
                                <td>Mozilla Firefox</td>
                                <td>10%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/panel/vertical/images/browser/opera.png" class="img-fluid" alt="opera"></th>
                                <td>Opera</td>
                                <td>5%</td>
                              </tr>
                            </tbody>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless mb-2">
                            <tbody>
                                <tr>
                                    <td><img src="assets/panel/vertical/images/users/girl.svg" width="35" alt="girl"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="assets/panel/vertical/images/users/men.svg" width="35" alt="men"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="assets/panel/vertical/images/users/boy.svg" width="35" alt="boy"></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="assets/panel/vertical/images/users/women.svg" width="35" alt="women"></td>
                                    <td>
...
@section('script')
<!-- Chart js -->
<script src="{{ asset('assets/panel/vertical/plugins/chart.js/chart.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/chart.js/chart-bundle.min.js') }}"></script>
<!-- Piety Chart js -->
<script src="{{ asset('assets/panel/vertical/plugins/peity/jquery.peity.min.js') }}"></script>
<!-- Vector Maps js -->
<script src="{{ asset('assets/panel/vertical/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- Custom Dashboard Social js -->
<script src="{{ asset('assets/panel/vertical/js/custom/custom-dashboard-social.js') }}"></script>
@endsection
