...
@section('style')
<!-- Pnotify css -->
<link href="{{ asset('assets/panel/vertical/plugins/pnotify/css/pnotify.custom.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Pnotify js -->
<script src="{{ asset('assets/panel/vertical/plugins/pnotify/js/pnotify.custom.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-pnotify.js') }}"></script>
@endsection
