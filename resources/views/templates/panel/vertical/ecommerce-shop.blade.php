...
@section('style')
<!-- Range Slider css -->
<link href="{{ asset('assets/panel/vertical/plugins/ion-rangeSlider/ion.rangeSlider.css') }}" rel="stylesheet" type="text/css">
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-vertical/ecommerce-single-product')}}"><img src="assets/panel/vertical/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="{{url('/template/panel-vertical/ecommerce-single-product')}}"><img src="assets/panel/vertical/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="product"></a>
...
@section('script')
<!-- Range Slider js -->
<script src="{{ asset('assets/panel/vertical/plugins/ion-rangeSlider/ion.rangeSlider.min.js') }}"></script>
<!-- eCommerce Shop Page js -->
<script src="{{ asset('assets/panel/vertical/js/custom/custom-ecommerce-shop-page.js') }}"></script>
@endsection
