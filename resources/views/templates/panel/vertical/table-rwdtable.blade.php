...
@section('style')
<!-- RWD Table css -->
<link href="{{ asset('assets/panel/vertical/plugins/rwd-table-patterns/rwd-table.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- RWD Table js -->
<script src="{{ asset('assets/panel/vertical/plugins/rwd-table-patterns/rwd-table.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-table-rwd.js') }}"></script>
@endsection
