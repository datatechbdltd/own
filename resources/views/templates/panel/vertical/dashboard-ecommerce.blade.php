...
<!-- Dropzone css -->
<link href="{{ asset('assets/panel/vertical/plugins/dropzone/dist/dropzone.css') }}" rel="stylesheet" type="text/css" />
<!-- C3 Charts css -->
<link href="{{ asset('assets/panel/vertical/plugins/c3/c3.min.css') }}" rel="stylesheet" type="text/css" />
<!-- Datepicker css -->
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body pb-1">
                    <div class="ecommerce-upload">
                        ...
                        <img src="assets/panel/vertical/images/dashboard/cloud.svg" class="img-fluid" alt="cloud">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">#1</th>
                                    <td><img src="assets/panel/vertical/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Apple MacBook Pro</td>
                                    <td>10,598</td>
                                </tr>
                                <tr>
                                    <th scope="row">#2</th>
                                    <td><img src="assets/panel/vertical/images/ecommerce/product_02.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Dell Alienware</td>
                                    <td>8,986</td>
                                </tr>
                                <tr>
                                    <th scope="row">#3</th>
                                    <td><img src="assets/panel/vertical/images/ecommerce/product_03.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Acer Predator Helios</td>
                                    <td>5,987</td>
                                </tr>
                                <tr>
                                    <th scope="row">#4</th>
                                    <td><img src="assets/panel/vertical/images/ecommerce/product_04.svg" class="img-fluid" width="35" alt="product"></td>
...
<!-- Dropzone JS -->
<script src="{{ asset('assets/panel/vertical/plugins/dropzone/dist/dropzone.js') }}"></script>
...
<!-- C3 Chart js -->
<script src="{{ asset('assets/panel/vertical/plugins/d3/d3.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/c3/c3.min.js') }}"></script>
<!-- Dashboard js -->
<script src="{{ asset('assets/panel/vertical/js/custom/custom-dashboard-ecommerce.js') }}"></script>
@endsection
