...
@section('script')
<!-- Session Timeout js -->
<script src="{{ asset('assets/panel/vertical/plugins/bootstrap-session-timeout/js/bootstrap-session-timeout.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-session-timeout.js') }}"></script>
@endsection
