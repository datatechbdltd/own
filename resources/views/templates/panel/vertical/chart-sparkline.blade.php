...
@section('script')
<!-- Sparkline Chart JS -->
<script src="{{ asset('assets/panel/vertical/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-chart-sparkline.js') }}"></script>
@endsection
