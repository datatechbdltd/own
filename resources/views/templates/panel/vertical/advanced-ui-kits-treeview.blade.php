...
@section('style')
<!-- JS Tree css -->
<link href="{{ asset('assets/panel/vertical/plugins/jstree/jstree.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- JS Tree js -->
<script src="{{ asset('assets/panel/vertical/plugins/jstree/jstree.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-jstree.js') }}"></script>
@endsection
