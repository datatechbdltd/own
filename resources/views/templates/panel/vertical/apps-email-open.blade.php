                ...
                <div class="card email-open-box m-b-30">
                    ...
                    <div class="card-body">
                        <div class="row m-b-30">
                            <div class="col-md-5">
                                <div class="media">
                                  <img class="align-self-center mr-3" src="assets/panel/vertical/images/users/men.svg" alt="Generic placeholder image">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <div class="card">
                                    <img class="card-img-top" src="./assets/panel/vertical/images/email/file-attached-1.jpg" alt="Generic placeholder image">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <img class="card-img-top" src="./assets/panel/vertical/images/email/file-attached-2.jpg" alt="Generic placeholder image">
                                    <div class="card-body text-center">
                                    <button type="button" class="btn btn-secondary-rgba">Download</button>
                                    </div>
                                </div>
