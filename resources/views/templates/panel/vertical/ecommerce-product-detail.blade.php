            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="d-inline-block mb-1">
                        <img src="assets/panel/vertical/images/ecommerce/product_gallery_01.jpg" alt="Rounded Image" class="img-fluid rounded">
                    </div>
                    <div class="d-inline-block mb-1">
                        <img src="assets/panel/vertical/images/ecommerce/product_gallery_02.jpg" alt="Rounded Image" class="img-fluid rounded">
                    </div>
                    <div class="d-inline-block mb-1">
                        <img src="assets/panel/vertical/images/ecommerce/product_gallery_03.jpg" alt="Rounded Image" class="img-fluid rounded">
                    </div>
                </div>
                <div class="card-footer">
...
<!-- eCommerce Page js -->
<script src="{{ asset('assets/panel/vertical/js/custom/custom-ecommerce-product-detail-page.js') }}"></script>
@endsection
