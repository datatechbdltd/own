...
@section('style')
<!-- Dragula css -->
<link href="{{ asset('assets/panel/vertical/plugins/dragula/dragula.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
                                            ...
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/vertical/images/users/men.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/vertical/images/users/women.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="avatar">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                        <img src="assets/panel/vertical/images/users/boy.svg" alt="avatar" class="rounded-circle">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
...
@section('script')
<!-- Dragula js -->
<script src="{{ asset('assets/panel/vertical/plugins/dragula/dragula.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-kanban.js') }}"></script>
@endsection
