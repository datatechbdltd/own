...
@section('style')
<!-- jQuery Confirm css -->
<link href="{{ asset('assets/panel/vertical/plugins/jquery-confirm/css/jquery-confirm.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- jQuery Confirm js -->
<script src="{{ asset('assets/panel/vertical/plugins/jquery-confirm/js/jquery-confirm.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-jquery-confirm.js') }}"></script>
@endsection
