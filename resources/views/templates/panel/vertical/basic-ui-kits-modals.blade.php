...
@section('style')
<!-- Animate css -->
<link href="{{ asset('assets/panel/vertical/plugins/animate/animate.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Model js -->
<script src="{{ asset('assets/panel/vertical/js/custom/custom-model.js') }}"></script>
@endsection
