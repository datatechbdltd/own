                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="{{url('/template/panel-vertical/page-product-detail')}}" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
                                            <a href="{{url('/template/panel-vertical/page-product-detail')}}" class="btn btn-danger-rgba"><i class="feather icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
