...
@section('script')
<!-- Tabledit js -->
<script src="{{ asset('assets/panel/vertical/plugins/tabledit/jquery.tabledit.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-table-editable.js') }}"></script>
@endsection
