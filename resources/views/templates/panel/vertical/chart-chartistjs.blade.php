...
@section('style')
<!-- Chartist Chart css -->
<link href="{{ asset('assets/panel/vertical/plugins/chartist-js/chartist.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Chartist Chart JS -->
<script src="{{ asset('assets/panel/vertical/plugins/chartist-js/chartist.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/plugins/chartist-js/chartist-plugin-tooltip.min.js') }}"></script>
<script src="{{ asset('assets/panel/vertical/js/custom/custom-chart-chartistjs.js') }}"></script>
@endsection
