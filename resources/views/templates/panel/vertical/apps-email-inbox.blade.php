            ...
            <div class="email-leftbar">
                <div class="card m-b-30">
                    <div class="card-header text-center">
                        <a href="{{url('/template/panel-vertical/apps-email-compose')}}" class="btn btn-danger-rgba btn-lg btn-block py-2 px-0 font-18"><i class="feather icon-plus mr-2"></i>Compose</a>
                    </div>
                    <div class="card-body">
                        <ul class="list-group">
                          <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/template/panel-vertical/apps-email-inbox')}}" class="active"><i class="feather icon-inbox mr-2"></i>Inbox</a>
                            ...
                            <table class="table table-hover table-borderless">
                                <tbody>
                                    <tr class="email-unread">
                                        ...
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Yes Bank Limited</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Google</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Amazon</a></td>
                                    ...
                                    <tr class="email-unread">
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Twitter</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Youtube</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">MaxBupa </a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">KredX </a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star-on font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Swiggy</a></td>
                                    ...
                                    <tr class="email-unread">
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Instant Approval</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><i class="feather icon-star font-18"></i></td>
                                        <td><a href="{{url('/template/panel-vertical/apps-email-open')}}">Pinterest </a></td>
